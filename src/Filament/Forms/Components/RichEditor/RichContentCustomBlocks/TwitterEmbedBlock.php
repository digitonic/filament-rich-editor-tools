...
class TwitterEmbedBlock extends RichContentCustomBlock
{
    ...
    public static function toPreviewHtml(array $config): string
    {
        ...
        $view = 'filament-rich-editor-tools::filament.rich-editor-custom-blocks.previews.twitter-embed';
    ...
    {
        /** @var view-string $view */
        $view = 'filament-rich-editor-tools::filament.rich-editor-custom-blocks.rendered.twitter-embed';
